...
export const SearchBar = () => {
  ...
  const { execute: refreshList } = useAsync({
    asyncFunction: handleSearchGiphy,
    immediate: false,
  });
  const { execute: defaultList } = useAsync({
    asyncFunction: handleDefaultGiphy,
    immediate: false,
  });
  ...
  return (
    <div className="search-bar">
      ...
      <button className="common-button" onClick={refreshList}>
        Search
      </button>
      <button className="common-button" onClick={defaultList}>
        Clear
      </button>
    </div>
  );
